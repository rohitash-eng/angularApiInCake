...
class OrderItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subscription_plan_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'created' => '2016-09-15 07:35:00',
            'modified' => '2016-09-15 07:35:00'
        ],
    ];
}
