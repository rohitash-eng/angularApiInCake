...
/**
 * PatientAddressFixture
 *
 */
class PatientAddressFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'address_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'zip_code' => 1,
            'created' => '2016-12-15 14:17:52',
            'modified' => '2016-12-15 14:17:52'
        ],
    ];
}
