...
use App\Model\Table\ImmunizationTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ImmunizationTypesTable Test Case
 */
class ImmunizationTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ImmunizationTypesTable
     */
    public $ImmunizationTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ImmunizationTypes') ? [] : ['className' => 'App\Model\Table\ImmunizationTypesTable'];
        $this->ImmunizationTypes = TableRegistry::get('ImmunizationTypes', $config);
    }
