...
use App\Model\Table\UserMailboxesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\UserMailboxesTable Test Case
 */
class UserMailboxesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\UserMailboxesTable
     */
    public $UserMailboxes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('UserMailboxes') ? [] : ['className' => 'App\Model\Table\UserMailboxesTable'];
        $this->UserMailboxes = TableRegistry::get('UserMailboxes', $config);
    }
