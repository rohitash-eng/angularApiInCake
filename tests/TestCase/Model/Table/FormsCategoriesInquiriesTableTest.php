...
use App\Model\Table\FormsCategoriesInquiriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\FormsCategoriesInquiriesTable Test Case
 */
class FormsCategoriesInquiriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\FormsCategoriesInquiriesTable
     */
    public $FormsCategoriesInquiries;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('FormsCategoriesInquiries') ? [] : ['className' => 'App\Model\Table\FormsCategoriesInquiriesTable'];
        $this->FormsCategoriesInquiries = TableRegistry::get('FormsCategoriesInquiries', $config);
    }
    ...
    {
        unset($this->FormsCategoriesInquiries);
