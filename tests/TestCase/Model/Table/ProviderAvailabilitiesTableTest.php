...
use App\Model\Table\ProviderAvailabilitiesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProviderAvailabilitiesTable Test Case
 */
class ProviderAvailabilitiesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ProviderAvailabilitiesTable
     */
    public $ProviderAvailabilities;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProviderAvailabilities') ? [] : ['className' => 'App\Model\Table\ProviderAvailabilitiesTable'];
        $this->ProviderAvailabilities = TableRegistry::get('ProviderAvailabilities', $config);
    }
    ...
    {
        unset($this->ProviderAvailabilities);
