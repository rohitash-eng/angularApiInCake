/**
 * @api {get} Immunizations/getPatientImmunizations:2 Get Patient Immunizations
 * @apiName Get Patient Immunizations
 * @apiGroup Immunizations And Vitals
 *
 * @apiDescription Get Patient Immunizations By Patient Id.
 * 
 * @apiHeader {String} TOKEN      * A token send by header as TOKEN
 *
 * @apiParam {Number} /:2    * Patient id requried field in url query string
 *
