/**
 * @api {put} patientMedicalHistories/editMedicalProblems?id=10 Edit Medical Problems
 * @apiName editMedicalProblems
 * @apiGroup Medical History
 *
 * @apiDescription Edit medical problems of Patient.
 * 
