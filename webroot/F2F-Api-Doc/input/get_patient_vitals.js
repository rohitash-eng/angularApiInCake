/**
 * @api {get} Vitals/getPatientVitals:1 Get Patient Vitals
 * @apiName Get Patient Vitals
 * @apiGroup Immunizations And Vitals
 *
 * @apiDescription Get Patient Vitals From Patietn Id.
 * 
 * @apiHeader {String} TOKEN      * A token send by header as TOKEN
 *
 * @apiParam {Number} /:1    * Patient id requried field in url query string
 *
