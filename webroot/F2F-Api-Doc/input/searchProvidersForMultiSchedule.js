/**
* @api {post} /patients/searchProvidersForMultiSchedule Multi provider appointment
* @apiName searchProvidersForMultiSchedule
* @apiGroup Consumer
* @apiPermission Consumer
*
* @apiDescription Search providers for schedule a multi provider appointment.
* 
