define({ "api": [
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response-Example:",
          "content": "    HTTP/1.1 success\n{\n  \"status\": true,\n  \"message\": \"The request is OK\",\n  \"data\": [\n    {\n      \"id\": 148,\n      \"consult_medium\": \"Video\",\n      \"insurance_plan_id\": null,\n      \"insurance_accepted\": \"No\",\n      \"request_status\": \"Accept\",\n      \"start_url\": \"https://zoom.us/s/729811243?zpk=thAnavACpkWWW_hRfWoQz4Sa-WtNsRj6ynQSzZHlINg.AwckYjFmZmFkZTYtZDE0NC00ODFiLTljYmYtNmY3M2M5MmExZjA0Fm8xaC1kUmhjU2ZtZVN4d1p1a0RFQlEWbzFoLWRSaGNTZm1lU3h3WnVrREVCURxkaGlyZW5kcmEuc2luZ2hAa2l3aXRlY2guY29tYwB_NGlqTU5xVkxzRDZjQXVNcjZZLXpDRm91V2xRenpfanE4cjItbDF0ZmQzOC5CZ01zVmtablFXUnJkMnhCWjI5dk5USkdjVEJDTTBwd2VFNHlUM1V5VURGUE0wdFVja05xWTJkMlptVm5WVDBBQUF3elEwSkJkVzlwV1ZNemN6MAAAFk5NelhOQlRIVGktam5lNEZUaWRfNGcCAgEA\",\n      \"join_url\": \"https://zoom.us/j/729811243?pwd=tWzAHHXJzXQ%3D\",\n      \"is_followed_up\": \"N\",\n      \"claim_status_send\": \"N\",\n      \"re_schedule_by\": null,\n      \"re_schedule_request_date\": null,\n      \"payment_status\": \"Y\",\n      \"consult_request_date_time\": \"2016-11-11T12:28:11+00:00\",\n      \"consultation_start_date\": \"2016-11-19T00:00:00+00:00\",\n      \"consultation_start_time\": \"2016-12-21T02:31:00+00:00\",\n      \"start_time\": \"2016-11-19 02:31:00\",\n      \"end_time\": \"2016-11-19 03:31:00\",\n      \"consultation_end_time\": \"2016-12-21T03:31:00+00:00\",\n      \"speciality\": {\n        \"id\": 3,\n        \"provider_type\": {\n          \"title\": \"General Health\"\n        }\n      },\n      \"insurance_plan\": null,\n      \"inquiry_type\": {\n        \"name\": \"Medical Problem\"\n      },\n      \"inquiry\": {\n        \"name\": \"Medical Problem-2\"\n      },\n      \"patient_authorization_form\": {\n        \"relationship_to_patient\": \"Father\"\n      },\n      \"provider\": {\n        \"id\": 213,\n        \"fname\": \"dhirendra\",\n        \"lname\": \"singh\"\n      },\n      \"consumer\": {\n        \"id\": 213,\n        \"dob\": null,\n        \"photo\": null,\n        \"photo_name\": null,\n        \"gender\": \"\",\n        \"fname\": \"dhirendra\",\n        \"lname\": \"singh\",\n        \"consumer_billing_details\": [\n          {\n            \"user_id\": 213,\n            \"type\": \"P\",\n            \"city\": \"ertert\",\n            \"state_id\": 1,\n            \"state\": {\n              \"name\": \"Alaska\"\n            }\n        }\n      }\n    ]\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/pages/getMenuElearning",
    "title": "Get ELearning menu",
    "name": "Get_ELearning_menu",
    "group": "Pages",
    "description": "<p>Get ELearning menu</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "\n/pages/getMenuElearning",
        "type": "json"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>List of E Learning menu with id, title and slug</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "input/eLearning_menu.js",
    "groupTitle": "Pages"
  },
  {
    "type": "get",
    "url": "/pages/getPageElearning/:slug",
    "title": "Get Elearning page by slug",
    "name": "Get_Elearning_page_by_slug",
    "group": "Pages",
    "description": "<p>Get Elearning page by slug i.e benefits,testimonials</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "\n/pages/getPageElearning/benefits",
        "type": "json"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>E-Learning Page Data with page data and banner data if any by slug</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "input/eLearning_page.js",
    "groupTitle": "Pages"
  },
  {
    "type": "get",
