    ...
    (function ($) {
        $.fn.fbuilder = function (options) {
            var opt = $.extend({},
                    {
                        typeList: new Array(
                                {id: "ftext", name: "Single Line Text", layout:"text"}, 
                                //{id: "fnumber", name: "Number", layout:"short_text"}, 
                                //{id: "femail", name: "Email"}, 
                                {id: "fdate", name: "Date", layout:"date_input"}, 
                                {id: "ftextarea", name: "Text Area", layout:"large_text"}, 
                                {id: "fcheck", name: "Checkboxes", layout:"checkboxes"}, 
                                {id: "fradio", name: "Radio Buttons", layout:"options_buttons"}, 
                                {id: "fdropdown", name: "Dropdown", layout:"dropdown_box"}, 
                                {id: "ffile", name: "Upload file", layout:"file_upload"} 
                                //{id: "fpassword", name: "Password"}, 
                                //{id: "fPhone", name: "Phone field"}, 
                                //{id: "fCommentArea", name: "Instruct. Text"}, 
                                //{id: "fSectionBreak", name: "Section break"}, 
                                //{id: "fPageBreak", name: "Page break"}
                            ),
                        pub: false,
                        identifier: "",
                        title: ""
            ...
            for (var i = 0; i < opt.typeList.length; i++)
                $("#tabs-1").append('<div class="button width40 itemForm tool_card" id="' + opt.typeList[i].id + '"><span class="icon_tools ' + opt.typeList[i].layout + '"></span><span class="text">' + opt.typeList[i].name + '</span></div>');
            ...
            editItem = function (id) {
                ...
                try {
                    //$('#edit_mediical_form').modal('show');
                    $('#fields-setting-info').html(items[id].showAllSettings());
                } catch (e) {
                }
                itemSelected = id;
            ...
            reloadItemsPublic = function () {
                ...
                if (i > 0)
                {
                    ...
                    try {
                        $("#fbuilder" + opt.identifier).tooltip({show: false, hide: false, tooltipClass: "uh-tooltip", position: {my: "left top", at: "left bottom", collision: "none"}, items: "[uh]", content: function () {
                                return $(this).attr("uh");
                            }});
                    } catch (e) {
                    }
            ...
            var showSettings = {
                ...
                showTitle: function (f, v) {
                    var str = '<label>Field Label</label><textarea class="large form-control log" name="sTitle" id="sTitle">' + v + '</textarea>';
                    if (v == "Page Break")
                        str = "";
                    return '<label>Field Type: ' + getNameByIdFromType(f) + '</label>' + str;
                },
                showName: function (v1, v2) {
                    return '<div style="display:none"><label>Field Name :</label><input class="large form-control log" name="sShortlabel" id="sShortlabel" value="' + v2 + '" /></div>' +
                            '<div style="display:none"><label>Field tag for the message (optional):</label><input readonly="readonly" class="large form-control log" name="sNametag" id="sNametag" value="&lt;%' + v1 + '%&gt;" />' +
                            '<input style="display:none" readonly="readonly" class="large form-control log" name="sName" id="sName" value="' + v1 + '" /></div>';
                },
                showPredefined: function (v, c) {
                    return '<div><label>Predefined Value</label><textarea class="large form-control log" name="sPredefined" id="sPredefined">' + v + '</textarea><br /><input type="checkbox" class="form-control log" name="sPredefinedClick" id="sPredefinedClick" ' + ((c) ? "checked" : "") + ' value="1" > Hide predefined value on click.</div>';
                },
                showEqualTo: function (v, name) {
                    return '<div><label>Equal to [<a class="helpfbuilder" text="Use this field to create password confirmation field or email confirmation fields.\n\nSpecify this setting ONLY into the confirmation field, not in the original field.">help?</a>]</label><br /><select class="equalTo" class="form-control log" name="sEqualTo" id="sEqualTo" dvalue="' + v + '" dname="' + name + '"></select></div>';
                },
                showRequired: function (v) {
                    return '<div class="required"><input type="checkbox" class="" name="sRequired" id="sRequired" ' + ((v) ? "checked" : "") + '><label>Required</label></div>';
                },
                showSize: function (v) {
                    var str = "";
                ...
                showUserhelp: function (v, c) {
                    return '<div><label>Instructions for User</label><textarea class="large form-control log" name="sUserhelp" id="sUserhelp">' + v + '</textarea><br /><input type="checkbox" name="sUserhelpTooltip" id="sUserhelpTooltip" ' + ((c) ? "checked" : "") + ' value="1" > Show as floating tooltip.</div>';
                },
                showCsslayout: function (v) {
                    return '<label>Add Css Layout Keywords</label><input class="large form-control log" name="sCsslayout" id="sCsslayout" value="' + v + '" />';
                }
            };
            var fform = function () {
            };
            $.extend(fform.prototype, {
                ...
                showAllSettings: function () {
                    ...
                    return '<div><label>Form Name</label><input class="large form-control log" name="fTitle" id="fTitle" value="' + htmlEncode(this.title) + '" /></div><div><label>Description</label><textarea class="large form-control log" name="fDescription" id="fDescription">' + this.description + '</textarea></div><div><label>Label Placement</label><br /><select name="fLayout" class="form-control log" id="fLayout">' + str + '</select></div>';
                }
            ...
            $.extend(ftext.prototype, ffields.prototype, {
                ...
                //equalTo: "",
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="wrapper dfield"><input class="field disabled form-control ui ' + this.size + '" type="text" value="' + htmlEncode(this.predefined) + '"/><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                ...
                showSpecialDataInstance: function () {
                    return '<div class="column min-length"><label>Min length/characters</label><input name="sMinlength" class="form-control log" id="sMinlength" value="' + this.minlength + '"></div><div class="column max-length"><label>Max length/characters</label><input name="sMaxlength" class="form-control log" id="sMaxlength" value="' + this.maxlength + '"></div><div class="clearer"></div>';
                }
            });
            ...
            $.extend(fpassword.prototype, ffields.prototype, {
                ...
                equalTo: "",
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="remove ui-icon ui-icon-trash "></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="wrapper dfield"><input class="field disabled form-control ui ' + this.size + '" type="password" value="' + htmlEncode(this.predefined) + '"/><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                ...
                showSpecialDataInstance: function () {
                    return '<div class="column min-length"><label>Min length/characters</label><input class="form-control log" name="sMinlength" id="sMinlength" value="' + this.minlength + '"></div><div class="column  max-length"><label>Max length/characters</label><input class="form-control log" name="sMaxlength" id="sMaxlength" value="' + this.maxlength + '"></div><div class="clearer"></div>';
                }
            });
            var femail = function () {
            };
            ...
            $.extend(fnumber.prototype, ffields.prototype, {
                ...
                showFormatIntance: function () {
                    ...
                    return '<div class="format_digit customselect"><label>Number Format</label><select class="form-control log" name="sFormat" id="sFormat">' + str + '</select></div>';
                },
                showRangeIntance: function () {
                    return '<div class="column"><label>Min</label><br /><input name="sMin" id="sMin" value="' + this.min + '"></div><div class="column"><label>Max</label><br /><input class="form-control log" name="sMax" id="sMax" value="' + this.max + '"></div><div class="clearer"></div>';
                }
            });
            var fdate = function () {
            };
            $.extend(fdate.prototype, ffields.prototype, {
                ...
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + ' (' + this.dformat + ')</label><div class="wrapper input-group date dfield "><input class="field disabled form-control ui ' + this.size + '" type="text" value="' + htmlEncode(this.predefined) + '"/><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                ...
                showFormatIntance: function () {
                    ...
                    for (var i = 0; i < this.formats.length; i++)
                        str += '<option value="' + this.formats[i] + '" ' + ((this.formats[i] == this.dformat) ? "selected" : "") + '>' + this.formats[i] + '</option>';
                    return '<div style="display:none"><label>Date Format</label><select name="sFormat" id="sFormat">' + str + '</select></div>';
                },
                showSpecialDataInstance: function () {
                    var str = "";
                    str += '<div style="display:none"><label>Default date</label><input class="medium form-control log" name="sDefaultDate" id="sDefaultDate" value="' + this.defaultDate + '" /></div>';
                    //str += '<div><label>Min date [<a class="helpfbuilder" text="You can put one of the following type of values into this field:\n\nEmpty: No min Date.\n\nDate: A Fixed date with the same date format indicated in the &quot;Date Format&quot; drop-down field.\n\nNumber: A number of days from today. For example 2 represents two days from today and -1 represents yesterday.\n\nString: A smart text indicating a relative date. Relative dates must contain value (number) and period pairs; valid periods are &quot;y&quot; for years, &quot;m&quot; for months, &quot;w&quot; for weeks, and &quot;d&quot; for days. For example, &quot;+1m +7d&quot; represents one month and seven days from today.">help?</a>]</label><br /><input class="medium form-control log" name="sMinDate" id="sMinDate" value="' + this.minDate + '" /></div>';
                    //str += '<div><label>Max date [<a class="helpfbuilder" text="You can put one of the following type of values into this field:\n\nEmpty: No max Date.\n\nDate: A Fixed date with the same date format indicated in the &quot;Date Format&quot; drop-down field.\n\nNumber: A number of days from today. For example 2 represents two days from today and -1 represents yesterday.\n\nString: A smart text indicating a relative date. Relative dates must contain value (number) and period pairs; valid periods are &quot;y&quot; for years, &quot;m&quot; for months, &quot;w&quot; for weeks, and &quot;d&quot; for days. For example, &quot;+1m +7d&quot; represents one month and seven days from today.">help?</a>]</label><br /><input class="medium form-control log" name="sMaxDate" id="sMaxDate" value="' + this.maxDate + '" /></div>';
                    //str += '<div class="inline-block"><input type="checkbox" name="sShowDropdown" id="sShowDropdown" ' + ((this.showDropdown) ? "checked" : "") + '/><label>Show Dropdown Year and Month</label><div id="divdropdownRange" style="display:' + ((this.showDropdown) ? "" : "none") + '">Year Range [<a class="helpfbuilder" text="The range of years displayed in the year drop-down: either relative to today\'s year (&quot;-nn:+nn&quot;), absolute (&quot;nnnn:nnnn&quot;), or combinations of these formats (&quot;nnnn:-nn&quot;)">help?</a>]: <input type="text" class="form-control log" name="sDropdownRange" id="sDropdownRange" value="' + htmlEncode(this.dropdownRange) + '"/></div></div>';
                    return str;
                }
            });
            ...
            $.extend(ftextarea.prototype, ffields.prototype, {
                ...
                maxlength: "",
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="wrapper large_text dfield"><textarea rows="4" class="field disabled form-control ui  ' + this.size + '">' + this.predefined + '</textarea><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
            ...
            $.extend(ffile.prototype, ffields.prototype, {
                ...
                size: "medium",
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="wrapper dfield custom_browse_field"><span><input type="text" class="field disabled form-control ui ' + this.size + '" /></span><span class="btn btn-success btn-file">Browse</span><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                    return '<div class="fields added_fields' + this.csslayout + '" id="field' + opt.identifier + '-' + this.index + '"><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield"><input type="file" id="' + this.name + '" name="' + this.name + '" class="field ' + this.size + ((this.required) ? " required" : "") + '" /><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                }
            });
            ...
            $.extend(fSectionBreak.prototype, ffields.prototype, {
                ...
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="remove ui-icon ui-icon-trash "></div><div class="section_break"></div><label>' + this.title + '</label><span class="uh">' + this.userhelp + '</span><div class="clearer"></div></div>';
                },
                show: function () {
                    return '<div class="fields added_fields' + this.csslayout + ' section_breaks" id="field' + opt.identifier + '-' + this.index + '"><div class="section_break" id="' + this.name + '" ></div><label>' + this.title + '</label><span class="uh">' + this.userhelp + '</span><div class="clearer"></div></div>';
                }
            });
            ...
            $.extend(fPhone.prototype, ffields.prototype, {
                ...
                display: function () {
                    ...
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="remove ui-icon ui-icon-trash "></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield">' + str + '<span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                    var str = "";
                    var tmp = this.dformat.split(' ');
                    ...
                    return '<div class="fields added_fields' + this.csslayout + '" id="field' + opt.identifier + '-' + this.index + '"><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield"><input type="hidden" id="' + this.name + '" name="' + this.name + '" class="field " />' + str + '<span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                showFormatIntance: function () {
            ...
            $.extend(fCommentArea.prototype, ffields.prototype, {
                ...
                userhelp: "A description of the section goes here.",
                display: function () {
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="remove ui-icon ui-icon-trash "></div><label>' + this.title + '</label><span class="uh">' + this.userhelp + '</span><div class="clearer"></div></div>';
                },
                show: function () {
                    return '<div class="fields added_fields' + this.csslayout + ' comment_area" id="field' + opt.identifier + '-' + this.index + '"><label id="' + this.name + '">' + this.title + '</label><span class="uh">' + this.userhelp + '</span><div class="clearer"></div></div>';
                }
            });
            var fcheck = function () {
            };
            $.extend(fcheck.prototype, ffields.prototype, {
                ...
                display: function () {
                    ...
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield checkbox_ui">' + str + '<span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                    this.choicesVal = ((typeof (this.choicesVal) != "undefined" && this.choicesVal !== null) ? this.choicesVal : this.choices.slice(0));
                    var str = "";
                    ...
                    return '<div class="fields added_fields' + this.csslayout + '" id="field' + opt.identifier + '-' + this.index + '"><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield">' + str + '<span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                showChoiceIntance: function () {
                    ...
                    for (var i = 0; i < l.length; i++)
                    {
                        str += '<div class="choicesEdit"><input class="choice_check" i="' + i + '" type="checkbox" ' + ((this.choiceSelected[i]) ? "checked" : "") + '/><input class="choice_text form-control log" i="' + i + '" type="text" name="sChoice' + this.name + '" id="sChoice' + this.name + '" value="' + htmlEncode(l[i]) + '"/><input style="display:none" class="choice_value form-control log" i="' + i + '" type="text" name="sChoice' + this.name + 'V' + i + '" id="sChoice' + this.name + 'V' + i + '" value="' + htmlEncode(lv[i]) + '"/><a class="choice_add ui-icon ui-icon-circle-plus" i="' + i + '" title="Add another choice.">A</a><a class="choice_remove ui-icon ui-icon-circle-minus" i="' + i + '" title="Delete this choice.">D</a></div>';
                        for (var j = 0; j < d[i].length; j++)
                    ...
                    return '<div class="choicesSet ' + ((this.showDep) ? "show" : "hide") + '"><label>Choices</label><div><div style="display:none" class="t">Text</div><div style="display:none" class="t">Value</div><div class="clearer"></div></div>' + str + '</div>';
                }
            });
            var fradio = function () {
            };
            $.extend(fradio.prototype, ffields.prototype, {
                ...
                display: function () {
                    ...
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="dfield options_button">' + str + '<span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                    this.choicesVal = ((typeof (this.choicesVal) != "undefined" && this.choicesVal !== null) ? this.choicesVal : this.choices.slice(0));
                    var str = "";
            ...
            $.extend(fdropdown.prototype, ffields.prototype, {
                ...
                display: function () {
                    this.choicesVal = ((typeof (this.choicesVal) != "undefined" && this.choicesVal !== null) ? this.choicesVal : this.choices.slice(0));
                    return '<div class="fields added_fields" id="field' + opt.identifier + '-' + this.index + '"><div class="arrow ui-icon ui-icon-play "></div><div class="edit ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools edit"></i></a></div><div class="remove ui-icon ui-icon-trash actions"><a href="javascript:void(0)" class="icon_tools delete"></i></a></div><label>' + this.title + '' + ((this.required) ? "*" : "") + '</label><div class="wrapper dfield customselect"><select class="field disabled form-control ui ' + this.size + '" ><option>' + this.choiceSelected + '</option></select><span class="uh">' + this.userhelp + '</span></div><div class="clearer"></div></div>';
                },
                show: function () {
                    this.choicesVal = ((typeof (this.choicesVal) != "undefined" && this.choicesVal !== null) ? this.choicesVal : this.choices.slice(0));
                    var l = this.choices;
